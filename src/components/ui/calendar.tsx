    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-gray-400 hover:text-white hover:bg-gray-800"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-gray-100 aria-selected:opacity-100 hover:bg-gray-800"
        ),
        ...
        day_outside: "text-gray-500 opacity-50 aria-selected:bg-gray-800/50",
